    ...
    return function t(e, n, i) {
        ...
        1: [function (t, e, n) {
            ...
            i.prototype._notify = function (t) {
                ...
                let $this = $('.horizontal-scroll')[0];
                a.hasWheelEvent && $this.addEventListener("wheel", this._onWheel), a.hasMouseWheelEvent && $this.addEventListener("mousewheel", this._onMouseWheel), a.hasTouch && ($this.addEventListener("touchstart", this._onTouchStart), $this.addEventListener("touchmove", this._onTouchMove)), a.hasPointer && a.hasTouchWin && (this.bodyTouchAction = document.body.style.msTouchAction, document.body.style.msTouchAction = "none", $this.addEventListener("MSPointerDown", this._onTouchStart, !0), $this.addEventListener("MSPointerMove", this._onTouchMove, !0)), a.hasKeyDown && document.addEventListener("keydown", this._onKeyDown)
                ...
                y = function (t) {
                    ...
                    return o(e, t), l(e, [{
                        ...
                        key: "_update", value: function () {
                            let scroll_value = 0;
                            if (this.vars.scrollValue > 5) scroll_value = this.vars.scrollValue;
                            this.vars.scrollValue += (this.vars.scrollTarget - scroll_value) * this.vars.spring;
                            var t = this.vars.scrollTarget - scroll_value, e = t / this.options.skewReducer;
                            this.vars.speed = this._clamp(-e, -this.options.skewLimit, this.options.skewLimit), this.options.isAnimated ? this.wrapper.style[this.transform] = "translate3d(-" + scroll_value + "px, 0 ,0) skewX(" + this.vars.speed + "deg)" : this.wrapper.style[this.transform] = "translate3d(-" + scroll_value + "px, 0 ,0)", this.vars.oldScrollValue = scroll_value, this.raf(this._update)
                        }
                    }, {
